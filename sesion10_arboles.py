# -*- coding: utf-8 -*-
"""
Created on Tue Aug 15 19:41:38 2023
...
#%%
#Escribimos las columnas categoricas
columnas_categoricas = ["genero", "puerto_salida"]
#Esto me va a convertir las variables genero y puerto_salida en columnas categoricas
#Recordando que las columnas categóricas son aquellas de 0 y 1 en la que
#0 representa que esa columna no cumple esa caracteristica y 1 es todo loc contrario
datos_categoricos = pd.get_dummies(mi_data[columnas_categoricas])

#%%
#Voy a crear una nueva tabla llamada pasajeros
pasajeros = (
    pd.concat([
        #Quiero la tabla excepto las columnas categóricas
...
#%%
#Aqui me quito los na alicando el promedio en donde se encuentre un na
pasajeros.edad = pasajeros.edad.fillna(pasajeros.edad.mean())

#Aqui termino el preprocesamiento
#%%
...
#Cuando hace el .fit ya hace todo lo que vimos en la teoría
arbol.fit(variables_independientes, variable_objetivo)

#%% 
#Usamos validación cruzada simplemente por el hecho de que ya tiene rato
# que no la usamos
#Le paso el modelo (en este caso es arbol) las v.i y la variable obj.
...
os.environ["PATH"] = os.pathsep + "C:/Users/IVAN MARTINEZ BRAVO/Desktop/RESPALDO IVAN 1 08 22/ESCRITORIOO/SciData Courses/Machine_Learning23/Graphviz/bin"
...
#Me va a devolver un diccionario con la importancia de cada variable
dict(zip(
...
#%%
#El primer renglón de l tabla pasajeros

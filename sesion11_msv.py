# -*- coding: utf-8 -*-
"""
Created on Wed Aug 16 21:10:39 2023
...
#%%
#mando a llamar el entrenamiento y prueba
from sklearn.model_selection import train_test_split

iris_X_train, iris_X_test, iris_y_train, iris_y_test = train_test_split(variables_independientes,
                                                                        variable_objetivo, test_size=0.3,random_state=20)

#%%
#Trabajaremos con entrenamiento prueba y con validación cruzada
#Importo SVC para clasificar
...
#Aqui calculamos el f1, le pasas de coder modelo, la variable objetivo
